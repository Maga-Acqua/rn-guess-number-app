...
const StartGameScreen = props => {
    ...
    useEffect(() => {
        //Para prevenir error de estilo por cambio de orientacion
        const updateLayout = () => {
    ...
    return (
        <ScrollView>
            <KeyboardAvoidingView behavior="padding" keyboardVerticalOffset={20}>
                <TouchableWithoutFeedback onPress={() => { //Permite que toda la superficie sea Touchable
                    Keyboard.dismiss();
                }}>
...
const styles = StyleSheet.create({
    ...
    /* button: {
        //width: 90
        //Dimensions.get('window') para conocer los pixeles del device disponibles
